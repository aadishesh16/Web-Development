        ...
        <div id="container">
            ...
            <form id="summary" action="viewresult.php" method="post">
              ...
              ?>
                        ...
                        <li><input type="submit" value="Back" name="back" class="btn btn-primary" title="View Results"/></li>
                        <?php
                        }
                        else
                        {
                        ...
                        <tr>
                            <td colspan="2" ><hr style="color:#ff0000;border-width:4px;"/></td>
                                ...
                                if(mysql_num_rows($result1)==0) {
                                    echo"<h3 style=\"color:#0000cc;text-align:center;\">1.Sorry because of some problems Individual questions Cannot be displayed.</h3>".mysql_error();
                                }
                                else {
                                    ?>
