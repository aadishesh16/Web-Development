...
if (!isset($_SESSION['stdname'])) {
    ...
    } else {    // yaha changes krni h extra elseif lagega for not clicked!!
...
?>
        <div id="container">
            <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="images/logo.png" alt="Practice Test"/><h3 class="headtext"> &nbsp;Practice Adda </h3><h4 style="color:#ffffff;text-align:center;margin:0 0 5px 5px;"><i>...आओ परीक्षा सरल बनाएं|</i></h4>
            </div>
...
?>
            ...
            echo "style=\"color:#ff0000;\"";
                            ...
                            <td><?php echo "<input type=\"submit\" value=\"Change 1 \" name=\"change\" class=\"btn btn-primary\" />"; ?></td>
                        </tr>
                        <tr>
                            <td>2</td>
                        ...
                        echo "style=\"color:#ff0000;\"";
                            ...
                            <td><?php echo "<input type=\"submit\" value=\"Change 2 \" name=\"change\" class=\"btn btn-primary\" />"; ?></td>
                        </tr>
                        <tr>
                        ...
                        <table border="0" width="100%" class="ntab">
                            ...
                            <tr><td >1. <input type="radio" name="answer" value="DennisRitchie" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "DennisRitchie") == 0) {
                                ...
                                echo "checked";
                                    ...
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
                                        <th style="width:80%;"><h4><input type="submit" name="viewsummary" value="View Summary" class="btn btn-primary"/></h4></th>
                                        <th style="width:12%;text-align:right;"><h4><input type="submit" name="previous" value="Previous" class="btn btn-primary"/></h4></th>
                                        <th style="width:8%;text-align:right;"><h4><input type="submit" name="summary" value="Summary" class="btn btn-primary" /></h4></th>
                                    </tr>
...
?>
                            <div class="tc">
                                ...
                                echo "checked";
                                    ...
                                    <tr><td>&nbsp;</td></tr>
                                    <tr>
                                        <th style="width:80%;"><h4><input type="submit" name="next" value="Next" class="btn btn-primary"/></h4></th>
                                        <th style="width:8%;text-align:right;"><h4><input type="submit" name="fsum" value="Summary" class="btn btn-primary" /></h4></th>
                                    </tr>
